  ...
  const handleEditTrigger = async (blog) => {
    ...
    try {
      ...
      setFormData({
        ...
        seoTitle: fullBlogData.seoTitle || '',
        seoDescription: fullBlogData.seoDescription || '',
        focusKeyword: fullBlogData.focusKeyword || '',
      });
    ...
    try {
      ...
      const cleanedContent = formData.content.map((block) => {
        ...
        if (block.type === 'image' && block.file) {
          blockCopy.imageFileIndex = newImageCounter;
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-1">Manage Articles</p>
          </div>
          <button 
            onClick={() => { resetForm(); setIsEditOpen(true); }}
            className="flex items-center gap-2 bg-black text-white px-6 py-3 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[#E68736] transition-all shadow-lg"
          >
      ...
      {isEditOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative w-full max-w-5xl mx-auto bg-white rounded-[2.5rem] h-[90vh] overflow-hidden shadow-2xl flex flex-col animate-in zoom-in-95 duration-300">
            ...
            <div className="bg-black p-6 md:p-8 shrink-0 flex justify-between items-center">
              <div>
              ...
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                ...
                <div className="flex-1 space-y-8">
                      ...
                      <div key={block.id || block._id || block.blockId} className="group relative p-6 md:p-8 bg-white border border-gray-100 rounded-[2rem] shadow-sm">
                        ...
                        {block.type === 'list' && (
                          <div className="space-y-4">
                            <p className="text-[10px] font-black text-gray-400 uppercase">List Items</p>
                            {block.listItems?.map((item, index) => (
                              <div key={index} className="flex items-center gap-2 group/item">
                                ...
                                <button 
                                  type="button" 
                                  onClick={() => {
                                    const newList = block.listItems.filter((_, i) => i !== index);
                                    updateContentBlock(block.id || block._id || block.blockId, { listItems: newList });
                                  }}
                            ...
                            <button 
                              ...
                              className="text-[10px] font-black text-orange-500 uppercase tracking-widest flex items-center gap-1 mt-2"
                            >
                              <FiPlus /> Add Item
                            </button>
                          </div>
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <label className="block text-[9px] font-black text-gray-400 uppercase tracking-widest mb-4">SEO Settings</label>
                    <div className="space-y-4">
                      <div>
                        <p className="text-[8px] font-bold text-gray-500 uppercase mb-1">Meta Title</p>
                        <input 
                          type="text"
                      ...
                      <div>
                        <p className="text-[8px] font-bold text-gray-500 uppercase mb-1">Focus Keyword</p>
                        <input 
                          type="text"
                          className="w-full p-3 bg-white border border-gray-100 rounded-xl text-xs outline-none focus:border-orange-400"
                      ...
                      <div>
                        <p className="text-[8px] font-bold text-gray-500 uppercase mb-1">Meta Description</p>
                        <textarea 
                          className="w-full p-3 bg-white border border-gray-100 rounded-xl text-xs outline-none focus:border-orange-400 resize-none h-20"
