...
function CouponForm({ onSuccess, initialData }) {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      if (initialData.buyXGetY?.buyCategory) detectedTab = "CATEGORY";
    ...
    <form className="p-8 space-y-8" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-1">
          ...
          <input
            value={formData.code}
            required
            className="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-[#E68736] outline-none font-mono font-bold"
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            required
            className="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl focus:border-[#E68736] outline-none font-bold"
      ...
      <div className="space-y-1">
        ...
        <textarea
          ...
          rows={3}
          className="w-full p-4 bg-slate-50 border-2 border-slate-100 rounded-2xl outline-none resize-none"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {["PERCENT", "FIXED", "FREESHIP", "BUY_X_GET_Y_FREE"].map(t => (
            <button
              ...
              className={`p-3 rounded-xl text-[10px] font-black border-2 transition-all ${
            ...
            <div className="flex gap-2 justify-center mb-4">
              {["BRAND", "CATEGORY"].map(t => (
                <button
                  ...
                  className={`px-4 py-1 rounded-lg text-[10px] font-black ${bogoTab === t ? 'bg-[#E68736] text-white' : 'bg-white text-slate-400 shadow-sm'}`}
                >
                  {t}
                </button>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 bg-slate-50 rounded-2xl">
              <label className="text-[10px] font-black text-slate-400 block mb-1">
                Discount {formData.couponType === 'PERCENT' ? '%' : '₹'}
              </label>
              <input
        ...
        {formData.applicableTo !== "ALL" && (
          <div className="space-y-1 md:col-span-2">
            ...
            <select
              ...
              value={
                formData.applicableTo === "BRAND" ? formData.applicableBrands[0] || ""
                : formData.applicableTo === "CATEGORY" ? formData.applicableCategories[0] || ""
                : ""
              }
              onChange={(e) => {
                const val = e.target.value;
      ...
      <button
        type="submit"
        className={`w-full py-6 text-white rounded-[2rem] font-black text-xl transition-all shadow-xl flex items-center justify-center gap-3 ${
          formData.isActive ? 'bg-slate-900 hover:bg-[#E68736]' : 'bg-slate-500 hover:bg-slate-600'
        }`}
      >
